...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-01-04 14:43`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ecab3f80-a4b9-4f0e-a1a4-e495ab383ba4.git
$ cd ecab3f80-a4b9-4f0e-a1a4-e495ab383ba4
```
